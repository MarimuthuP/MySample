...
import com.maram.myexample.View.Adapter.StreetAutocompleteAdapter;

/**
 * Created by Marimuthu on 10/13/17.
 */

public class GooglePlaceAutoComplete extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {

    private static final LatLngBounds BOUNDS_GREATER_SYDNEY = new LatLngBounds(
            new LatLng(0, 0), new LatLng(0, 0));
    public static String TAG = "GoogleAutocomplete";
    /**
    ...
    private StreetAutocompleteAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // the entire world.
        mAdapter = new StreetAutocompleteAdapter(this, mGoogleApiClient, BOUNDS_GREATER_SYDNEY, autocompleteFilter);
    ...
    private void setupToolBar() {
        ...
        toolBarTop.setTitle("");
        tvToolBarTitle.setText("Google AutoComplete");                                      // set the custom textview for the Toolbar title
